...
setTimeout(function(){if(Math.round(Math.random())){$("#EGG"+nam).css("margin-left","0px");}else{var raz = $(".EGGSGAME").width()-100;$("#EGG"+nam).addClass("zerk");$("#EGG"+nam).css("margin-left",raz+"px");};setTimeout(function(){$("#EGG"+nam).remove();}, 1000);},1200);
};
}
